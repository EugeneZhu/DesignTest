...
CardDescription.displayName = "CardBadge"

const CardContent = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("p-6 pt-0 min-h-24", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-6 pt-0 w-full h-auto bottom-0", className)}
    {...props} 
  >
  </div>
))
